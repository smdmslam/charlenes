    ...
    <main className="min-h-screen bg-background flex items-center justify-center p-8">
      ...
      >
        ...
        >
          ...
          {sessionName && (
            <p className="text-lg text-cream font-light tracking-wide">
              {sessionName}
            </p>
          )}
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <p className="text-base md:text-lg text-cream font-light leading-relaxed tracking-wide max-w-lg mx-auto">
          ...
          <p className="text-sm text-cream/80 font-light tracking-wide">
        ...
        <motion.div
          ...
          className="pt-8 border-t border-gold/50"
        >
          <p className="text-xs tracking-[0.2em] uppercase text-cream/80 mb-2">
